...
func RegisterRemoteHostTools(reg *ToolRegistry) {
	reg.Register(ToolEntry{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"command":     map[string]interface{}{"type": "string", "description": "Read-only shell command to run."},
				"cwd":         map[string]interface{}{"type": "string", "description": "Optional working directory on the remote host."},
				"timeout_sec": map[string]interface{}{"type": "integer", "minimum": 1, "maximum": 120, "description": "Optional timeout in seconds."},
				"reason":      map[string]interface{}{"type": "string", "description": "One-sentence explanation of what you are checking."},
			},
	...
	reg.Register(ToolEntry{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				"host":        map[string]interface{}{"type": "string", "description": "Required selected remote host ID."},
				"command":     map[string]interface{}{"type": "string", "description": "Shell command to run after user approval."},
				"cwd":         map[string]interface{}{"type": "string", "description": "Optional working directory on the remote host."},
				"timeout_sec": map[string]interface{}{"type": "integer", "minimum": 1, "maximum": 600, "description": "Optional timeout in seconds."},
				"reason":      map[string]interface{}{"type": "string", "description": "Short explanation of why this change is needed."},
			},
			"required":             []string{"host", "command", "reason"},
			"additionalProperties": false,
		},
	...
	reg.Register(ToolEntry{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				"host":        map[string]interface{}{"type": "string", "description": "Required selected remote host ID."},
				"path":        map[string]interface{}{"type": "string", "description": "Directory path to inspect."},
				"recursive":   map[string]interface{}{"type": "boolean", "description": "Whether to recursively list descendant entries."},
				"max_entries": map[string]interface{}{"type": "integer", "minimum": 1, "maximum": 500, "description": "Maximum number of entries to return."},
				"reason":      map[string]interface{}{"type": "string", "description": "One-sentence explanation of what you are inspecting."},
			},
	...
	reg.Register(ToolEntry{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				"host":      map[string]interface{}{"type": "string", "description": "Required selected remote host ID."},
				"path":      map[string]interface{}{"type": "string", "description": "Absolute or relative file path on the remote host."},
				"max_bytes": map[string]interface{}{"type": "integer", "minimum": 256, "maximum": 262144, "description": "Optional maximum bytes to read."},
				"reason":    map[string]interface{}{"type": "string", "description": "One-sentence explanation of what you are checking."},
			},
			"required":             []string{"host", "path", "reason"},
			"additionalProperties": false,
	...
	reg.Register(ToolEntry{
		...
		Parameters: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				"host":        map[string]interface{}{"type": "string", "description": "Required selected remote host ID."},
				"path":        map[string]interface{}{"type": "string", "description": "File or directory path to search."},
				"query":       map[string]interface{}{"type": "string", "description": "Text to search for."},
				"max_matches": map[string]interface{}{"type": "integer", "minimum": 1, "maximum": 200, "description": "Maximum number of matches to return."},
				"reason":      map[string]interface{}{"type": "string", "description": "One-sentence explanation of what you are searching for."},
			},
